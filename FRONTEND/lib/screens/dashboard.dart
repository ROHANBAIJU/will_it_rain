...
class _DashboardPageState extends State<DashboardPage> {
        ...
        children: [
          ...
          Theme(
            ...
            child: ExpansionTile(
              ...
              title: Row(
                children: const [
                  Icon(Icons.calendar_month, color: Color(0xFF06B6D4), size: 20),
                  SizedBox(width: 8),
                  Text('Calendar Integration', style: TextStyle(color: Colors.white)),
                ],
              ),
              trailing: Icon(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      // Calendar connect buttons with responsive layout
                      LayoutBuilder(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            _eventRow('Morning Jog • Tomorrow 7:00 AM', 'Perfect Weather',
                                chipColor: const Color(0x3310B981),
                                chipTextColor: const Color(0xFF6EE7B7)),
                            const SizedBox(height: 8),
                            _eventRow('Outdoor Meeting • Thu 2:00 PM', 'Bring Umbrella',
          ...
          Theme(
            ...
            child: ExpansionTile(
              tilePadding: const EdgeInsets.symmetric(horizontal: 8),
              initiallyExpanded: isDataOpen,
              onExpansionChanged: (v) => setState(() => isDataOpen = v),
              title: Row(
                children: const [
                  Icon(Icons.storage, color: Color(0xFFA78BFA), size: 20),
                  SizedBox(width: 8),
                  Text('Data Sources & Transparency', style: TextStyle(color: Colors.white)),
                ],
              ),
              trailing: Icon(
                isDataOpen ? Icons.expand_less : Icons.expand_more,
                color: Colors.white70,
                size: 20,
              ),
              backgroundColor: const Color(0x0DFFFFFF),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text(
                        'All weather predictions powered by NASA Earth Observation Data and verified sources.',
                        style: TextStyle(color: Colors.white70),
                      ),
                      const SizedBox(height: 12),
                      // Data sources with responsive layout
                      LayoutBuilder(
                        builder: (context, constraints) {
                            ...
                            return Column(
                              children: const [
                                _SourceTile(
                                  ...
                                  title: 'NASA MODIS',
                                  subtitle: 'Real-time satellite imagery and atmospheric data\nLast updated: 30 min ago',
                                  highlight: true,
                                ),
                                SizedBox(height: 12),
                                _SourceTile(
                                  icon: Icons.satellite_alt,
                                  title: 'NOAA GFS',
                                  subtitle: 'Global weather prediction models\nLast updated: 1 hour ago',
                                ),
                              ],
                            );
                          } else {
                            // Use Row/Wrap for larger screens
                            return Wrap(
                              spacing: 12,
                              runSpacing: 12,
                              children: const [
  ...
  static Widget _eventRow(String title, String badge,
      {required Color chipColor, required Color chipTextColor}) {
    return Row(
            ...
            child: Column(
              children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(999),
                        border:
                            Border.all(color: const Color(0x4D10B981)), // /30
                      ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              _MiniStat(icon: Icons.thermostat, label: 'Feels like 25°'),
                              const SizedBox(height: 4),
                              _MiniStat(icon: Icons.visibility, label: '10km visibility'),
                            ],
                          ),
                        ),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: const [
                                Icon(Icons.umbrella, size: 16, color: Color(0xFF06B6D4)),
                                SizedBox(width: 6),
                                Text('15% rain', style: TextStyle(color: Colors.white70)),
                              ],
                            ),
                            const SizedBox(height: 6),
                            Row(
                              ...
                              children: const [
                                ...
                                SizedBox(width: 6),
                                Text('12 km/h', style: TextStyle(color: Colors.white70)),
                              ],
                            ),
                          ],
                        ),
                    ...
                    if (isSmallScreen) {
                      ...
                      return Column(
                        children: const [
                          Row(
                            children: [
                              Expanded(child: _QuickStat(value: 'UV 7', label: 'High', color: Color(0xFFFACC15))),
                              SizedBox(width: 8),
                              Expanded(child: _QuickStat(value: '68%', label: 'Humidity', color: Color(0xFF06B6D4))),
                            ],
                          ),
                          SizedBox(height: 8),
                          Row(
                            children: [
                              Expanded(child: _QuickStat(value: '1013', label: 'Pressure (hPa)', color: Color(0xFF10B981))),
                              SizedBox(width: 8),
                              Expanded(child: _QuickStat(value: '6:45', label: 'Sunrise', color: Color(0xFFA78BFA))),
                            ],
                          ),
                        ],
                      );
                ...
                Container(
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      colors: [Color(0x4D059669), Color(0x4D0D9488)], // emerald/teal /30
                    ),
                    borderRadius: BorderRadius.circular(12),
                      ...
                      const Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 2),
                            Text('Low rain probability, comfortable temperature, light winds',
...
class _TodayCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final hours = [
      ...
      {'time': '12 PM', 'temp': '24°', 'icon': '☀️'},
      {'time': '1 PM', 'temp': '25°', 'icon': '☀️'},
      {'time': '2 PM', 'temp': '25°', 'icon': '🌤️'},
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Hourly Forecast', style: TextStyle(color: Colors.white, fontSize: 16)),
          const SizedBox(height: 8),
          SingleChildScrollView(
            scrollDirection: Axis.horizontal,
            child: Row(
              children: [
                for (final h in hours)
                  Padding(
                    ...
                    child: Column(
                      children: [
                        Text('${h['time']}', style: const TextStyle(color: Colors.white60, fontSize: 12)),
                        const SizedBox(height: 4),
                        Text('${h['icon']}', style: const TextStyle(fontSize: 22)),
                        const SizedBox(height: 2),
                        Text('${h['temp']}', style: const TextStyle(color: Colors.white)),
                      ],
                    ),
                  ),
              ],
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text("Tomorrow's Forecast", style: TextStyle(color: Colors.white, fontSize: 16)),
          const SizedBox(height: 12),
          Row(
            children: [
              Expanded(
                child: Column(
                  ...
                  children: const [
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        Text('26°', style: TextStyle(color: Colors.white, fontSize: 44)),
                        SizedBox(width: 6),
                        Text('C', style: TextStyle(color: Colors.white70, fontSize: 20)),
                      ],
                    ),
                    SizedBox(height: 4),
                    Text('Sunny', style: TextStyle(color: Colors.white70, fontSize: 16)),
                    SizedBox(height: 6),
                    Text('High: 26° / Low: 19°', style: TextStyle(color: Colors.white60, fontSize: 12)),
                  ],
                ),
              ),
              Container(
...
class _TenDayCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final days = [
      ...
      {'day': 'Friday', 'high': '25°', 'low': '18°', 'condition': 'Partly Cloudy', 'icon': '🌤️'},
      {'day': 'Saturday', 'high': '27°', 'low': '20°', 'condition': 'Sunny', 'icon': '☀️'},
      {'day': 'Sunday', 'high': '24°', 'low': '17°', 'condition': 'Thunderstorm', 'icon': '⛈️'},
      {'day': 'Monday', 'high': '22°', 'low': '16°', 'condition': 'Cloudy', 'icon': '☁️'},
      {'day': 'Tuesday', 'high': '23°', 'low': '17°', 'condition': 'Partly Cloudy', 'icon': '🌤️'},
      {'day': 'Wednesday', 'high': '25°', 'low': '18°', 'condition': 'Sunny', 'icon': '☀️'},
    ];
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('10-Day Forecast', style: TextStyle(color: Colors.white, fontSize: 16)),
          const SizedBox(height: 8),
          Column(
            children: [
              for (int i = 0; i < days.length; i++)
                Container(
                  ...
                  child: Row(
                    children: [
                      Text(days[i]['icon'] as String, style: const TextStyle(fontSize: 22)),
                      const SizedBox(width: 10),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(days[i]['day'] as String,
                                style: const TextStyle(color: Colors.white)),
                            Text(days[i]['condition'] as String,
                      ...
                      Row(
                        children: [
                          Text(days[i]['high'] as String,
                              style: const TextStyle(color: Colors.white)),
                          const SizedBox(width: 6),
                          Text(days[i]['low'] as String,
...
// ====== Reusable tile used in the "Data Sources / Transparency" section. ======
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return Container(
          ...
          width: constraints.maxWidth < 600 ? constraints.maxWidth : null,
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                height: 36,
                decoration: BoxDecoration(
                  color: highlight ? const Color(0x3310B981) : const Color(0x14FFFFFF),
                  borderRadius: BorderRadius.circular(8),
                  border: const Border.fromBorderSide(BorderSide(color: border)),
                ),
                alignment: Alignment.center,
                child: Icon(icon,
                    size: 18, color: highlight ? const Color(0xFF10B981) : Colors.white70),
              ),
