            ...
            return Column(
              ...
              children: [
                Wrap(
                  ...
                  runSpacing: 4,
                  children: const [
                    Text('© 2025 AeroNimbus', style: TextStyle(color: Color(0xFF6B6B6B), fontSize: 12)),
                    Text('•', style: TextStyle(color: Color(0xFFE8E4F3))),
                    Text('NASA Data', style: TextStyle(color: Color(0xFF6B6B6B), fontSize: 12)),
                  ],
                ),
            ...
            children: [
              Flexible(
                ...
                child: Wrap(
                  ...
                  runSpacing: 4,
                  children: const [
                    Text('© 2025 AeroNimbus', style: TextStyle(color: Color(0xFF6B6B6B))),
                    Text('•', style: TextStyle(color: Color(0xFFE8E4F3))),
